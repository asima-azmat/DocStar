...
class DoctorView extends Component
{
    ...
    componentWillMount() {
        this.props.getDoctor(this.props.match.params.id)
    }    
    ...
    render()
    {
        const { _id, blogText, feature_img, doctorId ,comments, blogHeading, createdAt} = this.props._doctor
        ...
        const CommentsVar = ({comments = []}) => (
          <div>
            {comments.map(comment => (
                <Panel>
                    <Panel.Heading>{DoctorView.giveName(comment.personId)} wrote:</Panel.Heading>
                        ...
                        <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
                            ...
                            <div className="post-metadata">
                                ...
                                <div className="post-info">
                                    ...
                                    <small>Published on {DoctorView.getCreatedDate(createdAt)}</small>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className="post-show-footer row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
                            <div id="responses" className="col-xs-10 col-md-6 col-xs-offset-1 col-md-offset-3 main-content">
                                <h4 className="medium-heading"><Badge>{DoctorView.getCommentCount(comments)}</Badge> Comments</h4>
...
DoctorView.propTypes = {params: PropTypes.object.isRequired}

export default connect(mapStateToProps, {getDoctor, clap, follow})(DoctorView);